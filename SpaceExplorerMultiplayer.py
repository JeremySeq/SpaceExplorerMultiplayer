...
def main():
    ...
    while run:
        ...
        if keys[pygame.K_RIGHT] and player2.x + player_vel + player2.get_width() < WIDTH:
            player2.x += player_vel
        if keys[pygame.K_UP] and player2.y - player_vel > 0:
            player2.y -= player_vel
        if keys[pygame.K_DOWN] and player2.y + player_vel + player.get_height() + 15 < HEIGHT:
            player2.y += player_vel
        if keys[pygame.K_PAGEUP] or keys[pygame.K_PAGEDOWN] or keys[pygame.K_RCTRL] or keys[pygame.K_RALT]:
            player2.shoot()
